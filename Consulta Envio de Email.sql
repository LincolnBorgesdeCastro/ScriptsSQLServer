...
WHERE (recipients LIKE '%ccau%'  
    OR copy_recipients LIKE '%ccau%' 
    OR blind_copy_recipients LIKE '%ccau%')

and sent_date > '2016-05-14 00:00:00.000'
and sent_date < '2016-05-15 00:00:00.000'
GO