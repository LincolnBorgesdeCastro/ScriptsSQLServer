...
MODIFY REPLICA ON N'AUSTRALIA' WITH  (PRIMARY_ROLE (READ_ONLY_ROUTING_LIST=('AUSTRALIA')));

ALTER AVAILABILITY GROUP [gd_Homologa2]
MODIFY REPLICA ON N'INDONESIA' WITH  (PRIMARY_ROLE (READ_ONLY_ROUTING_LIST=('AUSTRALIA')));
